...
export default function PaymentsAdmin() {
  ...
  function exportCsv() {
    const rows = [["Student", "Phone", "Item", "Amount", "Status", "Date"], ...payments.map((p) => [p.student_name, p.phone, p.item, String(p.amount), p.status, p.created_at.slice(0, 10)])];
  ...
  return (
    <div>
      ...
      <TableShell headers={["Student", "Phone", "Item", "Amount", "Reference / Gateway", "Status", "Date"]}>
        {payments.map((p) => (
