...
import { getWebinarFunnel, resolveRange, type RangePreset } from "@/lib/analytics/queries";
...
export async function GET(req: Request) {
  try {
    ...
    return NextResponse.json({ ok: false, error: "Failed to load webinar funnel." }, { status: 500 });
  }
}
