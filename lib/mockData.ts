...
export const courses: Course[] = [
  ...
  course({ id: "co-digital-saarthi", slug: "digital-saarthi", title: "Digital Saarthi", category: "Foundation", modes: ["Online", "Recorded"], price: 40000, description: "Self-paced digital foundation with structured drip release.", emi_config: { enabled: true, allow_full: true, seat_amount: 2000, allow_custom_seat: true, min_seat_amount: 2000, installment_counts: [3, 6, 10], first_interval_days: 7, interval_months: 1, best_value_note: "Best value" } }),
