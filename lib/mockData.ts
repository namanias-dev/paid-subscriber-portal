...
export const courses: Course[] = [
  ...
  course({ id: "co-digital-saarthi", slug: "digital-saarthi", title: "Digital Saarthi", category: "Foundation", modes: ["Online", "Recorded"], price: 40000, original_price: 50000, pay_in_full_price: 35000, description: "Self-paced digital foundation with structured drip release.", emi_config: { enabled: true, allow_full: true, seat_amount: 2000, allow_custom_seat: true, min_seat_amount: 2000, installment_counts: [3, 6, 10], first_interval_days: 7, interval_months: 1, best_value_note: "Best value" } }),
...
export const caPdfs: CaPdf[] = [
  ...
  {
    id: "capdf-sample-daily",
    title: "Daily Current Affairs (Sample)",
    kind: "daily",
    date_ref: new Date(now).toISOString().slice(0, 10),
    category_slug: null,
    file_url: "https://www.africau.edu/images/default/sample.pdf",
    cover_image: null,
    description: "Sample daily compilation record. Upload the real PDF from admin.",
    is_free: true,
    requires_login: false,
    requires_lead: false,
    generated: false,
