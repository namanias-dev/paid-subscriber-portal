...
export const ADMIN_NAV: AdminNavItem[] = [
  ...
  { href: "/admin/current-affairs", label: "CA Articles", icon: "📰", group: "Current Affairs" },
  { href: "/admin/current-affairs/pdfs", label: "PDF Library", icon: "📄", group: "Current Affairs" },
  { href: "/admin/current-affairs/analytics", label: "CA Analytics", icon: "📈", group: "Current Affairs" },
