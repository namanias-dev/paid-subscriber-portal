...
import type { Course, CourseCategory, LearningMode, FAQItem, ContactLink, PdfResource, Coupon } from "@/lib/types";
  ...
  return (
    ...
    >
      <Section title="Basics">
        ...
        <Field label="Long description" full hint="Full description on the course page.">
          <textarea className="input" rows={5} value={c.long_description || ""} onChange={(e) => set("long_description", e.target.value)} />
        </Field>
      ...
      <Section title="Contact links" desc="WhatsApp / phone / email buttons shown on the course page.">
